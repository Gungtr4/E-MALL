            ...
            <div class="content-bottom">
                <form method="post" enctype="multipart/form-data">
                    ...
                    <ul class="list-login-bottom">
                        <li class="">
                            <a href="cancel.php?kode=<?php echo $_GET['kode']?>&order=<?php echo $_SESSION['order']?>" class="text-right">Back Home</a>
                        </li>
	...
	$ins   = mysqli_query($koneksi,$sql) or die (mysqli_error($koneksi));
		if($ins){
				...
				<script>
					...
					window.location="bayar.php?kode='.$_GET['kode'].'&order='.$_GET['order'].'";
				</script>';
			}else{
				echo'
					<script>
