        ...
        <div class="content-w3ls">
            ...
            <div class="content-bottom">
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="field-group">
                        <div class="wthree-field">
                            <select name="gender" style="margin-left: 50px; width: 100px; height: 50px; border-color: white;">
					...
					<div class="field-group">
                        <div class="wthree-field">
							<input id="text1" type="text" value="" placeholder="Alamat" name="alamat" style="height: 90px; font-size: 18px " required>
                    	</div>
                    </div>
